"""
tests/e2e/web/fixtures/conftest.py
==================================
Pytest fixtures and test harnesses for the LiverAI Web E2E Test Suite.
Provides isolated test clients, mocked authentication sessions, sample payloads,
